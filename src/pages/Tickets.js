...
function Tickets() {
    ...
    const handleSubmit = async () => {
        setError('');
        if (!form.category || !form.description || !form.contactDetails) {
        ...
        <Box sx={{ backgroundColor: '#F5F7FA', minHeight: '100vh', pb: 4 }}>
            <Container sx={{ pt: 4 }}>
                ...
                <Grid container spacing={2} mb={3}>
                    {[
                        { label: 'Total', value: tickets.length, color: '#1976d2' },
                        { label: 'Open', value: open_count, color: '#f57c00' },
                        { label: 'In Progress', value: progress_count, color: '#0288d1' },
                        { label: 'Resolved', value: resolved_count, color: '#388e3c' },
                    ].map((s, i) => (
                        ...
                        <TableHead>
                            <TableRow sx={{ backgroundColor: '#d32f2f' }}>
                                {['ID', 'Category', 'Description',
                                  'Priority', 'Status', 'Reported By', 'Actions']
                                    .map(h => (
                                    <TableCell key={h}
                            ...
                            {tickets.length === 0 ? (
                                <TableRow>
                                    <TableCell colSpan={7} align="center"
                                               sx={{ py: 4, color: 'gray' }}>
                                        No tickets yet. Click "Report Incident" to add one!
                                    </TableCell>
                                </TableRow>
                            ) : (
                                tickets.map((t) => (
                ...
                <Dialog open={open} onClose={() => setOpen(false)}
                    ...
                    <DialogContent sx={{ pt: 2 }}>
                        ...
                        <TextField fullWidth select label="Related Resource"
                        ...
                        <TextField fullWidth select label="Category *"
                            margin="normal" value={form.category}
                        ...
                        <TextField fullWidth select label="Priority *"
                            margin="normal" value={form.priority}
                        ...
                        <TextField fullWidth label="Contact Details *"
                            margin="normal" value={form.contactDetails}
